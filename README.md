...
~~Promtheues is some what decent for obfuscation but still can be reversed~~ we now use moonveil for obfuscation since Prometheus can be deobfuscated, ill switch to luraph soon. 
